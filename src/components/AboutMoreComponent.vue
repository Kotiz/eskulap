<template>
  <section class="container px-6 py-8 mx-auto lg:py-16" id="aboutMore">
    <div class="lg:flex lg:items-center lg:-mx-4">
      <div class="lg:w-1/2 lg:px-4">
        ...
        <p class="mt-6 text-gray-500">
          ...
          laboriosam provident voluptatum id magni iste nobis corrupti, delectus
          quis repellat, debitis error quod explicabo molestiae rerum totam ab
          sunt excepturi?
        </p>

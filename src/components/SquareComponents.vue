        ...
        <section class="container px-6 py-8 mx-auto lg:py-16">
            <div class="grid grid-cols-1 gap-8 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
                <div class="p-8 space-y-3 border-2 border-indigo-400 rounded-xl">
                    ...
                    <h1 class="text-2xl font-semibold text-gray-700 capitalize">Square 1</h1>
                ...
                <div class="p-8 space-y-3 border-2 border-indigo-400 rounded-xl">
                    ...
                    <h1 class="text-2xl font-semibold text-gray-700 capitalize">Square 2</h1>
                ...
                <div class="p-8 space-y-3 border-2 border-indigo-400 rounded-xl">
                    ...
                    <h1 class="text-2xl font-semibold text-gray-700 capitalize">Square 3</h1>
